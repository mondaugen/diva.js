...
(function(c){c.updateHashParam=function(e,d){var b=c.getHashParam(e),a=window.location.hash;if(b!==d)if("string"==typeof b){var g=0<a.indexOf("&"+e+"=")?a.indexOf("&"+e+"="):a.indexOf("#"+e+"="),b=g+e.length+2+b.length;window.location.replace(a.substring(0,g)+(0==g?"#":"&")+e+"="+d+a.substring(b))}else 0===a.length?window.location.replace("#"+e+"="+d):window.location.replace(a+"&"+e+"="+d)}})(jQuery);
...
a)});this.handles.keydown(function(a){var b=!0,k=c(this).data("index.handle"),g,e,f;if(!d.options.disabled){switch(a.keyCode){case c.ui.keyCode.HOME:case c.ui.keyCode.END:case c.ui.keyCode.PAGE_UP:case c.ui.keyCode.PAGE_DOWN:case c.ui.keyCode.UP:case c.ui.keyCode.RIGHT:case c.ui.keyCode.DOWN:case c.ui.keyCode.LEFT:if(b=!1,!d._keySliding&&(d._keySliding=!0,c(this).addClass("active"),g=d._start(a,k),!1===g))return}g=d.options.step;d.options.values&&d.options.values.length?e=f=d.values(k):e=f=d.value();
switch(a.keyCode){case c.ui.keyCode.HOME:f=d._valueMin();break;case c.ui.keyCode.END:f=d._valueMax();break;case c.ui.keyCode.PAGE_UP:f=d._trimAlignValue(e+(d._valueMax()-d._valueMin())/5);break;case c.ui.keyCode.PAGE_DOWN:f=d._trimAlignValue(e-(d._valueMax()-d._valueMin())/5);break;case c.ui.keyCode.UP:case c.ui.keyCode.RIGHT:if(e===d._valueMax())return;f=d._trimAlignValue(e+g);break;case c.ui.keyCode.DOWN:case c.ui.keyCode.LEFT:if(e===d._valueMin())return;f=d._trimAlignValue(e-g)}d._slide(a,k,f);
...
b=f.offset();this._clickOffset=!c(d.target).parents().andSelf().is(".handle")?{left:0,top:0}:{left:d.pageX-b.left-f.width()/2,top:d.pageY-b.top-f.height()/2-(parseInt(f.css("borderTopWidth"),10)||0)-(parseInt(f.css("borderBottomWidth"),10)||0)+(parseInt(f.css("marginTop"),10)||0)};this.handles.hasClass("hover")||this._slide(d,l,a);return this._animateOff=!0},_mouseStart:function(c){return!0},_mouseDrag:function(c){var b=this._normValueFromMouse({x:c.pageX,y:c.pageY});this._slide(c,this._handleIndex,
...
maxPagesPerRow:8,maxZoomLevel:-1,minPagesPerRow:2,minZoomLevel:0,onModeToggle:null,onViewToggle:null,onJump:null,onPageLoad:null,onReady:null,onScroll:null,onScrollDown:null,onScrollUp:null,onZoom:null,onZoomIn:null,onZoomOut:null,pageLoadTimeout:200,pagesPerRow:5,rowLoadTimeout:50,throbberTimeout:100,tileFadeSpeed:0,tileHeight:256,tileWidth:256,viewerHeightPadding:15,viewerWidthPadding:30,viewportMargin:200,zoomLevel:2},b);c.extend(a,{allTilesLoaded:[],averageHeights:[],averageWidths:[],currentPageIndex:0,
...
panelWidth:0,plugins:[],previousTopScroll:0,preZoomOffset:null,realMaxZoom:-1,resizeTimer:-1,rowHeight:0,scaleWait:!1,selector:"",singleClick:!1,scrollbarWidth:0,throbberTimeoutID:-1,toolbar:null,topScrollSoFar:0,totalHeights:[],totalHeight:0,verticalOffset:0,verticalPadding:0,viewerXOffset:0,viewerYOffset:0});var e=this,f=function(a){var c,b,d;if("function"===typeof a){c=[];b=1;for(d=arguments.length;b<d;b++)c.push(arguments[b]);a.apply(e,c);return!0}return!1},h=function(c,b){return a.pages[c].d[a.zoomLevel][b]},
l=function(c){var b;for(b=0;b<a.numPages;b++)if(a.pages[b].f===c)return b;return-1},u=function(c,b){var d=a.topScrollSoFar-a.viewportMargin,f=d+a.panelHeight+2*a.viewportMargin;return c>=d&&c<=f||c<=d&&b>=f||b>=d&&b<=f},k=function(c){return 0<=c&&c<a.numPages},v=function(c){var b=a.heightAbovePages[c];c=b+h(c,"h")+a.verticalPadding;return u(b,c)},m=function(b){if(!(0<c(a.selector+"page-"+b).length&&a.allTilesLoaded[b])){var d=a.pages[b].f,e=h(b,"w"),g=h(b,"h"),p=a.heightAbovePages[b]+a.verticalPadding,
z=a.selector+"page-"+b,y;if(!(0<c(a.selector+"page-"+b).length))for(y in c(a.innerSelector).append('<div id="'+a.ID+"page-"+b+'" style="top: '+p+"px; width: "+e+"px; height: "+g+'px;" class="diva-document-page" title="Page '+(b+1)+'" data-index="'+b+'" data-filename="'+d+'">'+a.pageTools+"</div>"),f(a.onPageLoad,b,d,z),a.plugins)f(a.plugins[y].onPageLoad,b,d,z);a.pageTimeouts.push(setTimeout(function(){if(v(b)){var f=a.imageRoot+"/"+a.imageDir+"/",p=h(b,"r"),y=h(b,"c"),z=a.pages[b].m,M=a.iipServerURL+
"?FIF="+f+d+"&amp;JTL=",f=[],B=[],C=!0,l=0,D=g-(p-1)*a.tileHeight,k=e-(y-1)*a.tileWidth,A,N,m,K,I,s,t,q;for(A=0;A<p;A++)for(N=0;N<y;N++){I=A*a.tileHeight;s=N*a.tileWidth;t=a.tileFadeSpeed?"none":"inline";q=a.zoomLevel+z-a.realMaxZoom;m=A===p-1?D:a.tileHeight;K=N===y-1?k:a.tileWidth;q=M+q+","+l;if(!(0<c(a.selector+"tile-"+b+"-"+l).length)){var n=a.heightAbovePages[b]+A*a.tileHeight+a.verticalPadding,r=a.pageLeftOffsets[b]+N*a.tileWidth,O=r+a.tileWidth;if(n=u(n,n+a.tileHeight))var n=a.leftScrollSoFar-
a.viewportMargin,w=n+a.panelWidth+2*a.viewportMargin,L=O>=n&&O<=w,O=r<=n&&O>=w,n=r>=n&&r<=w||O||L;n?(B.push('<div id="'+a.ID+"tile-"+b+"-"+l+'" style="'+t+"; position: absolute; top: "+I+"px; left: "+s+"px; background-image: url('"+q+"'); height: "+m+"px; width: "+K+'px;"></div>'),f.push(l)):C=!1}l++}a.allTilesLoaded[b]=C;if(f.length){c(a.selector+"page-"+b).append(B.join(""));for(p=0;p<f.length;p++)c(a.selector+"tile-"+b+"-"+f[p]).fadeIn(a.tileFadeSpeed)}}},a.pageLoadTimeout))}},q=function(b){c(a.selector+
"page-"+b).empty().remove()},s=function(c,b){0<b?k(c)&&(v(c)?(m(c),a.lastPageLoaded=c,s(a.lastPageLoaded+1,b)):a.heightAbovePages[c]+h(c,"h")+a.verticalPadding<a.topScrollSoFar&&s(c+1,b)):k(c)&&(v(c)?(m(c),a.firstPageLoaded=c,s(a.firstPageLoaded-1,b)):a.heightAbovePages[c]>a.topScrollSoFar+a.panelHeight&&s(c-1,b))},n=function(c,b){0<b?k(c)&&a.heightAbovePages[c]+h(c,"h")+a.verticalPadding<a.topScrollSoFar&&(q(c),a.firstPageLoaded=c+1,n(a.firstPageLoaded,b)):k(c)&&a.heightAbovePages[c]>a.topScrollSoFar+
a.panelHeight&&(q(c),a.lastPageLoaded=c-1,n(a.lastPageLoaded,b))},r=function(c){return 0<=c&&c<a.numRows},t=function(c){c*=a.rowHeight;return u(c,c+a.rowHeight+a.fixedPadding)},F=function(b){if(!(0<c(a.selector+"row-"+b).length)){var d=[];d.push('<div class="diva-row" id="'+a.ID+"row-"+b+'" style="height: '+a.rowHeight+"; top: "+(a.rowHeight*b+a.fixedPadding)+'px;">');var f,e,g,p,y,z,M=a.imageRoot+"/"+a.imageDir+"/";for(f=0;f<a.pagesPerRow;f++){e=b*a.pagesPerRow+f;if(!k(e))break;g=a.pages[e].f;p=
h(e,"w");y=h(e,"h");z=a.fixedHeightGrid?(a.rowHeight-a.fixedPadding)*p/y:a.gridPageWidth;p=a.fixedHeightGrid?a.rowHeight-a.fixedPadding:z/p*y;y=parseInt(f*(a.fixedPadding+a.gridPageWidth)+a.fixedPadding,10);z=parseInt(z,10);p=parseInt(p,10);y+=a.fixedHeightGrid?(a.gridPageWidth-z)/2:0;g=a.iipServerURL+"?FIF="+M+g+"&amp;HEI="+(p+2)+"&amp;CVT=JPEG";d.push('<div id="'+a.ID+"page-"+e+'" class="diva-page" style="width: '+z+"px; height: "+p+"px; left: "+y+'px;" title="Page '+(e+1)+'"></div>');J(b,e,g,z,
p)}d.push("</div>");c(a.innerSelector).append(d.join(""))}},x=function(c,b){0<b?r(c)&&(t(c)?(F(c),a.lastRowLoaded=c,x(a.lastRowLoaded+1,b)):a.rowHeight*(c+1)<a.topScrollSoFar&&x(c+1,b)):r(c)&&(t(c)?(F(c),a.firstRowLoaded=c,x(a.firstRowLoaded-1,b)):a.rowHeight*c>a.topScrollSoFar+a.panelHeight&&x(c-1,b))},w=function(b,d){0<d?r(b)&&a.rowHeight*(b+1)<a.topScrollSoFar&&(c(a.selector+"row-"+b).empty().remove(),a.firstRowLoaded++,w(a.firstRowLoaded,d)):r(b)&&a.rowHeight*b>a.topScrollSoFar+a.panelHeight&&
(c(a.selector+"row-"+b).empty().remove(),a.lastRowLoaded--,w(a.lastRowLoaded,d))},J=function(b,d,f,e,g){a.pageTimeouts.push(setTimeout(function(){t(b)&&c(a.selector+"page-"+d).html('<img src="'+f+'" style="width: '+e+"px; height: "+g+'px;" />')},a.rowLoadTimeout))},H=function(c){var b=a.topScrollSoFar+a.panelHeight/2,d=a.currentPageIndex,f=a.currentPageIndex+c,e=!1;0>c?0<=f&&a.heightAbovePages[f]+h(f,"h")+a.verticalPadding>=b&&(e=!0):0<c&&a.heightAbovePages[d]+h(d,"h")+a.verticalPadding<b&&(e=!0);
return e?(a.currentPageIndex=f,0!==c&&(H(c)||a.toolbar.updateCurrentPage()),!0):!1},p=function(c){var b=Math.floor(a.currentPageIndex/a.pagesPerRow),d=b+parseInt(c,10),f=a.topScrollSoFar+a.panelHeight/2,e=!1;if(0>c){if(0<=d&&(a.rowHeight*b>=f||a.rowHeight*d>=a.topScrollSoFar))e=!0}else 0<c&&a.rowHeight*(b+1)<a.topScrollSoFar&&r(d)&&(e=!0);return e?(a.currentPageIndex=d*a.pagesPerRow,0!==c&&(p(c)||a.toolbar.updateCurrentPage()),!0):!1},z=function(b,d,e){d=a.heightAbovePages[b]+("undefined"!==typeof d?
d:0);e=(a.maxWidths[a.zoomLevel]-a.panelWidth)/2+a.horizontalPadding+("undefined"!==typeof e?e:0);c(a.outerSelector).scrollTop(d);c(a.outerSelector).scrollLeft(e);a.currentPageIndex=b;a.toolbar.updateCurrentPage();f(a.onJump,b)},M=function(b){var d=Math.floor(b/a.pagesPerRow)*a.rowHeight;c(a.outerSelector).scrollTop(d);a.currentPageIndex=b;a.toolbar.updateCurrentPage()},C=function(){a.allTilesLoaded=[];c(a.outerSelector).scrollTop(0);a.topScrollSoFar=0;c(a.innerSelector).empty();a.firstPageLoaded=
...
a.enableAutoTitle&&c(a.selector+"fullscreen").addClass("diva-contained"));b='<div id="'+a.ID+'tools-left" class="diva-tools-left'+l+'">'+e+f+p+h+'</div><div id="'+a.ID+'tools-right" class="diva-tools-right">'+d+b+'<div class="diva-page-nav">'+g+B+"</div></div>";c(a.parentSelector).prepend('<div id="'+a.ID+'tools" class="diva-tools">'+b+"</div>");c(a.selector+"zoom-slider").slider({value:a.zoomLevel,min:a.minZoomLevel,max:a.maxZoomLevel,step:1,slide:function(b,d){var e=a.currentPageIndex;a.goDirectlyTo=
e;var f=Math.pow(2,d.value-a.zoomLevel),g=a.maxWidths[a.zoomLevel]+2*a.horizontalPadding,p=c(a.outerSelector).scrollLeft()-(g-a.panelWidth)/2;a.horizontalOffset=g>a.panelWidth?p*f:0;a.verticalOffset=f*(c(a.outerSelector).scrollTop()-a.heightAbovePages[e]);P(d.value)},change:function(c,b){b.value!==a.zoomLevel&&P(b.value)}});c(a.selector+"grid-slider").slider({value:a.pagesPerRow,min:a.minPagesPerRow,max:a.maxPagesPerRow,step:1,slide:function(a,c){S(c.value)},change:function(c,b){b.value!==a.pagesPerRow&&
S(b.value)}});c(a.selector+"grid-icon").click(function(){L()});c(a.selector+"goto-page").submit(function(){var b=parseInt(c(a.selector+"goto-page-input").val(),10)-1;k(b)?a.inGrid?M(b):z(b,0,0):alert("Invalid page number");return!1});c(a.selector+"link-icon").click(function(){c("body").prepend('<div id="'+a.ID+'link-popup" class="diva-link-popup"><input id="'+a.ID+'link-popup-input" class="diva-input" type="text" value="'+V()+'"/></div>');if(a.inFullscreen)c(a.selector+"link-popup").addClass("in-fullscreen");
else{var b=c(a.outerSelector).offset().left+a.panelWidth,b=b+(a.scrollbarWidth-240-1),d=c(a.outerSelector).offset().top+1;c(a.selector+"link-popup").removeClass("in-fullscreen").css({top:d+"px",left:b+"px"})}c("body").mouseup(function(b){b=b.target.id;b!==a.ID+"link-popup"&&b!==a.ID+"link-popup-input"&&c(a.selector+"link-popup").remove()});c(a.outerSelector).scroll(function(){c(a.selector+"link-popup").remove()});c(a.selector+"link-popup input").click(function(){c(this).focus().select()});return!1});
var C=a.inGrid?"grid":"zoom";c(a.selector+C+"-slider").show();c(a.selector+C+"-slider-label").show();return{updateCurrentPage:function(){c(a.selector+"current-page").text(a.currentPageIndex+1)},setNumPages:function(b){c(a.selector+"num-pages").text(b)},updateZoomSlider:function(){a.zoomLevel!==c(a.selector+"zoom-slider").slider("value")&&c(a.selector+"zoom-slider").slider({value:a.zoomLevel});c(a.selector+"zoom-level").text(a.zoomLevel)},updateGridSlider:function(){a.pagesPerRow!==c(a.selector+"grid-slider").slider("value")&&
c(a.selector+"grid-slider").slider({value:a.pagesPerRow});c(a.selector+"pages-per-row").text(a.pagesPerRow)},switchView:function(){c(a.selector+C+"-slider").hide();c(a.selector+C+"-slider-label").hide();C=a.inGrid?"grid":"zoom";c(a.selector+C+"-slider").show();c(a.selector+C+"-slider-label").show();c(a.selector+"grid-icon").toggleClass("diva-in-grid")},switchMode:function(){c(a.selector+"tools").toggleClass("diva-fullscreen-tools");a.inFullscreen?(c(a.selector+"tools-right").after(c(a.selector+"tools-left")),
c(a.selector+"tools-left").addClass("in-fullscreen")):(c(a.selector+"tools-left").after(c(a.selector+"tools-right")),c(a.selector+"tools-left").removeClass("in-fullscreen"))}}},aa=function(){if(window.divaPlugins){var b=[];c.each(window.divaPlugins,function(d,e){var f=e.pluginName[0].toUpperCase()+e.pluginName.substring(1);a["enable"+f]&&e.init(a)&&(f=e.titleText||f+" plugin","function"===typeof e.handleClick&&(b.push('<div class="diva-'+e.pluginName+'-icon" title="'+f+'"></div>'),c(a.outerSelector).delegate(".diva-"+
e.pluginName+"-icon","click",function(c){e.handleClick.call(this,c,a)})),a.plugins.push(e))});b.length&&(a.pageTools='<div class="diva-page-tools">'+b.join("")+"</div>")}},X=function(){clearTimeout(a.throbberTimeoutID);c(a.selector+"throbber").hide()},ba=function(){var b='<div id="'+a.ID+'throbber" class="diva-throbber"></div>';c(a.outerSelector).append(b);a.throbberTimeoutID=setTimeout(function(){c(a.selector+"throbber").show()},a.throbberTimeout);c.ajax({url:a.divaserveURL,data:{d:a.imageDir},cache:!0,
dataType:"json",error:function(b){X();c(a.outerSelector).text("Invalid URL. Error code: "+b.status)},success:function(b){X();a.pages=b.pgs;a.maxRatio=b.dims.max_ratio;a.minRatio=b.dims.min_ratio;a.itemTitle=b.item_title;a.numPages=b.pgs.length;a.maxWidths=b.dims.max_w;a.averageWidths=b.dims.a_wid;a.averageHeights=b.dims.a_hei;a.totalHeights=b.dims.t_hei;a.realMaxZoom=b.max_zoom;a.maxZoomLevel=0<=a.maxZoomLevel&&a.maxZoomLevel<=b.max_zoom?a.maxZoomLevel:b.max_zoom;a.minZoomLevel=0<=a.minZoomLevel&&
a.minZoomLevel<=a.maxZoomLevel?a.minZoomLevel:0;a.minPagesPerRow=Math.max(2,a.minPagesPerRow);a.maxPagesPerRow=Math.max(a.minPagesPerRow,a.maxPagesPerRow);a.enableFilename?(b=c.getHashParam("i"+a.hashParamSuffix),b=l(b)):b=parseInt(c.getHashParam("p"+a.hashParamSuffix),10)-1;k(b)&&(a.goDirectlyTo=b);c.each(a.plugins,function(c,b){f(b.setupHook,a)});a.toolbar=Z();c(a.selector+"current label").text(a.numPages);a.enableAutoTitle&&c(a.parentSelector).prepend('<div id="'+a.ID+'title" class="diva-title">'+
a.itemTitle+"</div>");a.mobileWebkit?W():(a.originalWidth=c(a.parentSelector).width()-a.scrollbarWidth,a.originalHeight=c(a.outerSelector).height(),G());b=c(a.outerSelector).offset();a.viewerXOffset=b.left;a.viewerYOffset=b.top;a.inFullscreen?Q(!1):D();f(a.onReady,a)}})};(function(){a.scrollbarWidth=c.getScrollbarWidth();a.mobileWebkit=void 0!==window.orientation;a.ID=c.generateId("diva-");a.selector="#"+a.ID;var b=parseInt(a.ID,10);1<b&&(a.hashParamSuffix=b);a.outerSelector=a.selector+"outer";a.innerSelector=
a.selector+"inner";c(a.parentSelector).append('<div id="'+a.ID+'outer" class="diva-outer"></div>');c(a.outerSelector).append('<div id="'+a.ID+'inner" class="diva-inner diva-dragger"></div>');a.enableFullscreen&&c(a.parentSelector).prepend('<div id="'+a.ID+'fullscreen" class="diva-fullscreen-icon" title="Toggle fullscreen mode"></div>');b=parseInt(c.getHashParam("n"+a.hashParamSuffix),10);b>=a.minPagesPerRow&&b<=a.maxPagesPerRow&&(a.pagesPerRow=b);b=c.getHashParam("z"+a.hashParamSuffix);""!==b&&(b=
parseInt(b,10),b>=a.minZoomLevel&&(a.zoomLevel=b));b=parseInt(c.getHashParam("y"+a.hashParamSuffix),10);isNaN(b)||(a.verticalOffset=b);b=parseInt(c.getHashParam("x"+a.hashParamSuffix),10);isNaN(b)||(a.horizontalOffset=b);var b=c.getHashParam("g"+a.hashParamSuffix),d="true"===b,e=c.getHashParam("f"+a.hashParamSuffix);a.inGrid=a.inGrid&&"false"!==b||d;a.inFullscreen=a.inFullscreen&&"false"!==e||"true"===e;b=parseInt(c.getHashParam("h"+a.hashParamSuffix),10);d=parseInt(c.getHashParam("w"+a.hashParamSuffix),
10);a.minHeight=parseInt(c(a.outerSelector).css("min-height"),10);a.minWidth=parseInt(c(a.outerSelector).css("min-width"),10);(0<b||0<d)&&E(d,b);ba();aa();Y()})();this.getItemTitle=function(){return a.itemTitle};this.gotoPageByNumber=function(a){a-=1;k(a)&&z(a,0,0)};this.getCurrentPage=function(){return a.currentPageIndex};this.getZoomLevel=function(){return a.zoomLevel};this.setZoomLevel=function(b){a.inGrid&&L();return P(b)};this.zoomIn=function(){return this.setZoomLevel(a.zoomLevel+1)};this.zoomOut=
function(){return this.setZoomLevel(a.zoomLevel-1)};this.inViewport=function(b,c,d){b=a.heightAbovePages[b-1]+c;return u(b,b+d)};this.toggleMode=function(){K()};this.enterFullscreen=function(){return!a.inFullscreen?(K(),!0):!1};this.leaveFullscreen=function(){return a.inFullscreen?(K(),!0):!1};this.toggleView=function(){L()};this.enterGrid=function(){return!a.inGrid?(L(),!0):!1};this.leaveGrid=function(){return a.inGrid?(L(),!0):!1};this.gotoPageByName=function(a){a=l(a);return k(a)?(z(a),!0):!1};
this.getPageIndex=function(a){return l(a)};this.getCurrentURL=function(){return V()};this.getURLHash=function(){return U()};this.getState=function(){return T()};this.setState=function(b){var c;E(b.w,b.h);c=l(b.i);k(c)?a.goDirectlyTo=c:k(b.p)&&(a.goDirectlyTo=b.p);a.horizontalOffset=parseInt(b.x,10);a.verticalOffset=parseInt(b.y,10);b.z>=a.minZoomLevel&&b.z<=a.maxZoomLevel&&(a.zoomLevel=b.z);b.n>=a.minPagesPerRow&&b.n<=a.maxPagesPerRow&&(a.pagesPerRow=b.n);a.inFullscreen!==b.f?(a.inFullscreen=b.f,
Q(a.inGrid!==b.g)):a.inGrid!==b.g?(a.inGrid=b.g,B()):D()};this.resize=function(a,b){E(a,b);D()};this.destroy=function(){c("body").removeClass("diva-hide-scrollbar");c(a.parentSelector).empty().removeData("diva");c.each(a.plugins,function(a,b){f(b.destroy)});c(a.parentSelector).removeAttr("style").removeAttr("class")}};c.fn.diva=function(d){return this.each(function(){var b=c(this);if(!b.data("diva")){d.parentSelector=b;var a=new e(this,d);b.data("diva",a)}})}})(jQuery);(function(c){window.divaPlugins.push(function(){var e={},d={},b={},a,g,f,h={brightnessMax:150,brightnessMin:-100,brightnessStep:1,contrastMax:3,contrastMin:-1,contrastStep:0.05,localStoragePrefix:"canvas-",mobileWebkitMaxZoom:2,onInit:null,rgbMax:50,rgbMin:-50,throbberFadeSpeed:200,throbberTimeout:100},l=function(b,c){var d=b.context,e=b.size/2,f=-(b.width/2),g=-(b.height/2);d.clearRect(0,0,b.size,b.size);d.save();d.translate(e,e);d.rotate(c*Math.PI/180);d.drawImage(a,f,g,b.width,b.height);d.restore();
